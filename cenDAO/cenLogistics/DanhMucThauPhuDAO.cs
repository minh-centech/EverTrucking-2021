...
{
    public class DanhMucThauPhuDAO
    {
        public DataTable List(object ID, object IDDanhMucLoaiDoiTuong, object IDDanhMucNhomHangVanChuyen, object SearchStr)
        {
            ...
            DataTable dt = dao.tableList(sqlParameters, DanhMucThauPhu.listProcedureName, DanhMucThauPhu.tableName);
            return dt;
        }
        public bool Insert(ref DanhMucThauPhu obj)
        {
            try
            {
                using (SqlConnection sqlConnection = new SqlConnection(coreCommon.GlobalVariables.ConnectionString))
                {
                    ...
                    {
                        using (SqlCommand sqlCommand = new SqlCommand(DanhMucThauPhu.insertProcedureName, sqlConnection, sqlTransaction))
                        {
                            ...
                            sqlParameters[6] = new SqlParameter("@SoDienThoai", obj.SoDienThoai);
                            sqlParameters[7] = new SqlParameter("@MaSoThueCMND", obj.MaSoThueCMND);
                            sqlParameters[8] = new SqlParameter("@IDDanhMucNhomHangVanChuyen", obj.IDDanhMucNhomHangVanChuyen);
                            sqlParameters[9] = new SqlParameter("@KyHieuKeToan", obj.KyHieuKeToan);
                            ...
                            if (NhatKyDuLieuDAO.Insert(coreCommon.coreCommon.AllPropertiesAndValues(obj), obj.ID, null, null, coreCommon.ThaoTacDuLieu.Them, coreCommon.coreCommon.TraTuDien(DanhMucThauPhu.tableName), sqlConnection, sqlTransaction))
                            {
        ...
        public bool Update(ref DanhMucThauPhu obj)
        {
            try
            {
                using (SqlConnection sqlConnection = new SqlConnection(coreCommon.GlobalVariables.ConnectionString))
                {
                    ...
                    using (SqlTransaction sqlTransaction = sqlConnection.BeginTransaction())
                    {
                        using (SqlCommand sqlCommand = new SqlCommand(DanhMucThauPhu.updateProcedureName, sqlConnection, sqlTransaction))
                        {
                            sqlCommand.CommandType = CommandType.StoredProcedure;
                            SqlParameter[] sqlParameters = new SqlParameter[13];
                            ...
                            obj.ID = Int64.Parse(sqlParameters[0].Value.ToString());
                            obj.CreateDate = DateTime.Parse(sqlParameters[sqlParameters.Length - 1].Value.ToString());
                            if (NhatKyDuLieuDAO.Insert(coreCommon.coreCommon.AllPropertiesAndValues(obj), obj.ID, null, null, coreCommon.ThaoTacDuLieu.Sua, coreCommon.coreCommon.TraTuDien(DanhMucThauPhu.tableName), sqlConnection, sqlTransaction))
                            {
                                sqlTransaction.Commit();
                                return true;
                            }
        ...
        public bool Delete(DanhMucThauPhu obj)
        {
            try
            {
                using (SqlConnection sqlConnection = new SqlConnection(coreCommon.GlobalVariables.ConnectionString))
                {
                    ...
                    using (SqlTransaction sqlTransaction = sqlConnection.BeginTransaction())
                    {
                        using (SqlCommand sqlCommand = new SqlCommand(DanhMucThauPhu.deleteProcedureName, sqlConnection, sqlTransaction))
                        {
                            sqlCommand.CommandType = CommandType.StoredProcedure;
                            ...
                            sqlCommand.Parameters.AddRange(sqlParameters);
                            int rowAffected = sqlCommand.ExecuteNonQuery();
                            if (NhatKyDuLieuDAO.Insert(coreCommon.coreCommon.AllPropertiesAndValues(obj), obj.ID, null, null, coreCommon.ThaoTacDuLieu.Xoa, coreCommon.coreCommon.TraTuDien(DanhMucThauPhu.tableName), sqlConnection, sqlTransaction))
                            {
                                sqlTransaction.Commit();
                                return true;
                            }
