...
{
    public partial class frmDanhMucDiaDiemGiaoNhan : coreBase.BaseForms.frmBaseDanhMuc
    {
        DanhMucDiaDiemGiaoNhanBUS BUS;
        public frmDanhMucDiaDiemGiaoNhan()
        {
            InitializeComponent();
        }
        ...
        protected override void List()
        {
            ...
            BUS = new DanhMucDiaDiemGiaoNhanBUS();
        ...
        protected override void InsertDanhMuc()
        {
            ...
            base.InsertDanhMuc();
            if (!bContinue) return;
            frmDanhMucDiaDiemGiaoNhanUpdate frmUpdate = new frmDanhMucDiaDiemGiaoNhanUpdate
            {
        ...
        protected override void DeleteDanhMuc()
        {
            ...
            DanhMucDiaDiemGiaoNhan obj = new DanhMucDiaDiemGiaoNhan()
            {
                ID = dataRow["ID"]
            };
            DanhMucDiaDiemGiaoNhanBUS bus = new DanhMucDiaDiemGiaoNhanBUS();
            if (bus.Delete(obj))
            {
