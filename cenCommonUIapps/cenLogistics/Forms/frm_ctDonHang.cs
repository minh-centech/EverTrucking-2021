...
{
    public partial class frm_ctDonHang : coreBase.BaseForms.frmBaseChungTuSingleList
    {
        public frm_ctDonHang()
        {
            InitializeComponent();
        ...
        protected override void InsertDanhMuc()
        {
            ...
            frm_ctDonHangUpdate frmUpdate = new frm_ctDonHangUpdate
            {
        ...
        {
            if (ug.ActiveRow.IsDataRow && !coreCommon.coreCommon.IsNull(ug.ActiveRow.Cells["Huy"].Value) && bool.Parse(ug.ActiveRow.Cells["Huy"].Value.ToString()))
            {
