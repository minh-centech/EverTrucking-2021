...
{
    public partial class frmDanhMucTuyenVanTaiValid : Form
    {
        ...
        public frmDanhMucTuyenVanTaiValid()
        {
            InitializeComponent();
        }
        ...
        private void LoadDanhMuc(bool Refresh)
        {
            ...
            if (!coreCommon.coreCommon.IsNull(IDDanhMucLoaiDoiTuong) && !coreCommon.GlobalVariables.isAdmin && !Xem)
            {
                ...
                dataTable = bus.List(null, -1, null).Tables[DanhMucTuyenVanTai.tableName];
