...
namespace cenCommonUIapps.cenLogistics.Forms
{
    public partial class frm_ctChotChiPhiVanTaiBoSungGuiKeToan : Form
    {
        ...
        private void cmdChot_Click(object sender, EventArgs e)
        {
            ...
            if (objList.Count > 0)
            {
                if (coreCommon.coreCommon.QuestionMessage("Xác nhận chốt chi phí vận tải bổ sung những đơn hàng đã chọn?", 0) == DialogResult.Yes)
                {
                ...
                coreCommon.coreCommon.ErrorMessageOkOnly("Không có đơn hàng cần chốt chi phí vận tải bổ sung!");
        }
        ...
        private void cmdHuyChot_Click(object sender, EventArgs e)
        {
            ...
            if (objList.Count > 0)
            {
                if (coreCommon.coreCommon.QuestionMessage("Xác nhận hủy chốt chi phí vận tải bổ sung những đơn hàng đã chọn?", 0) == DialogResult.Yes)
                {
                ...
                coreCommon.coreCommon.ErrorMessageOkOnly("Không có đơn hàng cần hủy chốt chi phí vận tải bổ sung!");
        }
    }
}
