...
{
    public partial class frmDanhMucTaiXeValid : Form
    {
        ...
        private void InsertDanhMuc()
        {
            ...
            frmDanhMucTaiXeUpdate frmUpdate = new frmDanhMucTaiXeUpdate
            {
