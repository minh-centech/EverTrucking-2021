...
{
    public partial class frmDanhMucGiaNhienLieu : coreBase.BaseForms.frmBaseDanhMuc
    {
        ...
        protected override void List()
        {
            ...
            ug.DisplayLayout.Bands[0].Columns["NgayGioApDung"].MaskInput = coreCommon.GlobalVariables.MaskInputDateTime;
        }
