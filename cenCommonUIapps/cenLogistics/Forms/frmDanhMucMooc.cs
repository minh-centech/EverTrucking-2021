...
{
    public partial class frmDanhMucMooc : coreBase.BaseForms.frmBaseDanhMuc
    {
        DanhMucMoocBUS BUS = new DanhMucMoocBUS();
        public frmDanhMucMooc()
        {
            InitializeComponent();
        }
        protected override void List()
        {
            ...
            BUS = new DanhMucMoocBUS();
            dtData = BUS.List(DBNull.Value, IDDanhMucLoaiDoiTuong, null);
            dtData.TableName = DanhMucMooc.tableName;
        ...
        protected override void InsertDanhMuc()
        {
            ...
            base.InsertDanhMuc();
            if (!bContinue) return;
            frmDanhMucMoocUpdate frmUpdate = new frmDanhMucMoocUpdate
            {
        ...
        protected override void DeleteDanhMuc()
        {
            ...
            DanhMucMooc obj = new DanhMucMooc()
            {
                ID = dataRow["ID"]
            };
            if (BUS.Delete(obj))
